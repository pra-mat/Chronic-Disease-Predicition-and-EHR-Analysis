...
df = pd.read_csv(r"C:\Users\User\Desktop\DA Internship\Infotact Solution\Project 2 Healthcare and Medical- Chronic Disease Predicition and EHR Analysis\csv files\patients.csv")
...
df = pd.read_csv( r"C:\Users\User\Desktop\DA Internship\Infotact Solution\Project 2 Healthcare and Medical- Chronic Disease Predicition and EHR Analysis\csv files\medications.csv")
...
df = pd.read_csv(r"C:\Users\User\Desktop\DA Internship\Infotact Solution\Project 2 Healthcare and Medical- Chronic Disease Predicition and EHR Analysis\csv files\lab_results.csv")
...
# READ DATASETS
# -----------------------------
patients = pd.read_csv(r"C:\Users\User\Desktop\DA Internship\Infotact Solution\Project 2 Healthcare and Medical- Chronic Disease Predicition and EHR Analysis\csv files\patients.csv")

medications = pd.read_csv(r"C:\Users\User\Desktop\DA Internship\Infotact Solution\Project 2 Healthcare and Medical- Chronic Disease Predicition and EHR Analysis\csv files\medications.csv")

lab_results = pd.read_csv(r"C:\Users\User\Desktop\DA Internship\Infotact Solution\Project 2 Healthcare and Medical- Chronic Disease Predicition and EHR Analysis\csv files\lab_results.csv")
...
lab_results = pd.read_csv(
    r"C:\Users\User\Desktop\DA Internship\Infotact Solution\Project 2 Healthcare and Medical- Chronic Disease Predicition and EHR Analysis\csv files\lab_results.csv"
)

medications = pd.read_csv(
    r"C:\Users\User\Desktop\DA Internship\Infotact Solution\Project 2 Healthcare and Medical- Chronic Disease Predicition and EHR Analysis\csv files\medications.csv"
)
